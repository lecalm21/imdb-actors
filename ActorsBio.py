...
for x in range(50):
    ...
    print(pythonData.get('image').get('url'))
    print(pythonData.get('name'))
    print(pythonData.get('gender'))
    print(pythonData.get('heightCentimeters'))
    print(pythonData.get('birthDate'))
...
# print(bio[0]['id'].split("/")[2])
# print(bio[0]['image']['url'])
# print(bio[0]['name'])
# print(bio[0]['gender'])
# print(bio[0]['heightCentimeters'])
# print(bio[0]['birthDate'])
# print(bio[0]['birthPlace'])
# print(bio[0]['miniBios'][0]['text'])
